...
public class RatingCourseAct extends AppCompatActivity {
    ...
    protected void onPostCreate(@Nullable Bundle savedInstanceState) {
        ...
        Dictionary<Integer, RatingBar> rb_questions = new Hashtable<>();
    ...
    private boolean sendRatings(Dictionary<Integer, RatingBar> rb_questions, Dictionary<Integer, EditText> et_questions) {
        try {
            for (int i = 0; i < 10; i++) {
